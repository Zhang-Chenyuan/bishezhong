...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("                Manage member information\r\n");
      out.write("            </div>\r\n");
      ...
      out.print(path );
      out.write("/admin/member/member_Manage.jsp\" method=\"post\">\r\n");
      out.write("\r\n");
      out.write("<strong> username:</strong><input name=\"txt_lname\" type=\"text\" id=\"txt_lname\" style=\"width:150px;\"  />\r\n");
      out.write("<strong> Name:</strong><input name=\"txt_mname\" type=\"text\" id=\"txt_mname\" style=\"width:150px;\"  />\r\n");
      out.write("\r\n");
...
rs=cn.query("select  * from member a where "+where+" order by lname desc limit "+pageSize*(pageNow-1)+", "+pageSize);
      ...
      out.write("    <th >login password</th>\r\n");
      out.write("    <th >Name</th>\r\n");
      out.write("    <th >phone number</th>\r\n");
      out.write("    <th >E-mail</th>\r\n");
      out.write("    <th >Home address</th>\r\n");
      out.write("    <th >Registration time</th>\r\n");
...
while(rs.next()){
      ...
      out.write("           <a href=\"");
      out.print(path );
      out.write("/admin/member/member_Detail.jsp?id=");
      out.print(rs.getString("lname") );
      out.write("\">detailed</a>&nbsp;\r\n");
      out.write("           <a href=\"");
      out.print(path );
      out.write("/admin/member/member_Edit.jsp?id=");
      out.print(rs.getString("lname") );
      out.write("\">edit</a>&nbsp;\r\n");
      out.write("           <a href=\"");
      out.print(path );
      out.write("/member_Delete?id=");
      out.print(rs.getString("lname") );
      out.write("\">delete</a>\r\n");
      out.write("\t\t</tr>\r\n");
} 
