...
public final class seat_005fManage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.print(path );
      out.write("/admin/seat/seat_Manage.jsp\" method=\"post\">\r\n");
      out.write("\r\n");
      out.write("<strong> 所属停车场:</strong><select name=\"se_pid\" style='width:150px' id=\"pidid\">\r\n");
 ...
 while (rspid.next()) {
      ...
      out.write("\r\n");
      out.write("</select>\r\n");
      out.write("<strong> 车位名称:</strong><input name=\"txt_sname\" type=\"text\" id=\"txt_sname\" style=\"width:150px;\"  />\r\n");
      out.write("\r\n");
      out.write("                <input name=\"search\" type=\"submit\" border=\"0\" class=\"layui-layer-btn0 btn btn-primary\"\tvalue='查询' />\r\n");
      out.write("                </form>\r\n");
      out.write("\r\n");
      out.write("   </td>\r\n");
      out.write("            </tr>\r\n");
...
rs=cn.query("select  a.*,b.pname from seat a  left join parks b on a.pid=b.pid  where "+where+" order by sid desc limit "+pageSize*(pageNow-1)+", "+pageSize);
      ...
      out.write("\t\t<tr>\r\n");
      out.write("    <th >所属停车场</th>\r\n");
      out.write("    <th >车位名称</th>\r\n");
      out.write("    <th >车位规格</th>\r\n");
      out.write("\t\t\t<th scope=\"col\">操作</th>\t\t</tr>\r\n");
      out.write("\t\t");
...
while(rs.next()){
      ...
      out.write("</td>\r\n");
      out.write("  \t\t\t<td>");
      out.print(rs.getString("guig") );
      out.write("</td>\r\n");
      out.write("\t\t\t<td >\r\n");
      out.write("           <a href=\"");
      out.print(path );
      out.write("/admin/seat/seat_Edit.jsp?id=");
      out.print(rs.getString("sid") );
      out.write("\">编辑</a>&nbsp;\r\n");
      out.write("           <a href=\"");
      out.print(path );
      out.write("/seat_Delete?id=");
      out.print(rs.getString("sid") );
      out.write("\">删除</a>\r\n");
      out.write("\t\t</tr>\r\n");
} 
