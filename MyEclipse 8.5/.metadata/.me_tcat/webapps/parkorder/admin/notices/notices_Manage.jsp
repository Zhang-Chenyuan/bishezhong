    ...
    <div class="rows" style="margin-bottom: 1%; border: 1px solid #e6e6e6; overflow: hidden;  padding-left: 1px;">
        <div class="panel panel-default">
		  ...
		  <table class="layui-table" style="width:98%;margin-left:10px;" align="center">
                 ...
                 <tr>
                <td align="center">
                                    <form action="<%=path %>/admin/notices/notices_Manage.jsp" method="post">

<strong> announcement title:</strong><input name="txt_title" type="text" id="txt_title" style="width:150px;"  />
...
%>
		<tr align="center" >
           ...
           <a href="<%=path %>/admin/notices/notices_Edit.jsp?id=<%=rs.getString("nid") %>">edit</a>&nbsp;
           <a href="<%=path %>/notices_Delete?id=<%=rs.getString("nid") %>">delete</a>
		</tr>
<%} %>
