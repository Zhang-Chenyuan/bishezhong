...
<form  action="<%=path %>/notices_Add" method="post">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
               <i class="fa fa-thumbs-o-up fa-lg" style="padding-right: 5px;"></i>
                Add system announcement information
            </div>
...
<input name="txt_title" type="text" id="txt_title" style="width: 200px; " required /></div>
</div> 
 </td></tr>
...
<td class="tbright"><div style="display:inline;float:left;">
<textarea id="Textarea1"  name="Textarea1" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;"></textarea></div>
 </td></tr>
