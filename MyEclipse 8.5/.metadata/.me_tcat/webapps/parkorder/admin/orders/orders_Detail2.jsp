        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <table class="layui-table" style="width:98%;margin-left:10px;" align="center">
				...
				String sql = "select  a.*,b.pname,c.*,a.stime>now() as ttt from orders a  left join parks b on a.pid=b.pid left join member c on a.lname=c.lname where id=" + id ;
...
if( rs.getString("ttt").equals("1") ){
 %>
    
        <input type="button" name="btnAdd" value="cancel appointment" id="btnAdd" onclick="location.href='<%=path %>/orders_Delete?id=<%=rs.getString("id") %>&flag=1'"  class="layui-layer-btn0 btn btn-primary" />
        <%} %>
