...
<form  action="<%=path %>/seat_Edit" method="post">
    ...
    <div class="rows" style="margin-bottom: 1%; border: 1px solid #e6e6e6; overflow: hidden;  padding-left: 1px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				String sql = "select * from seat where sid=" + id ;
...
String idpid = rspid.getString("pid");
if (pid.equals(idpid)) {

	out.println("<option value=\"" + rspid.getString("pid") + "\" selected=\"selected\">"
												+ rspid.getString("pname") + "</option>");
} else {

	out.println("<option value=\"" + rspid.getString("pid") + "\" >"
												+ rspid.getString("pname") + "</option>");
}
}
if (rspid != null)
...
<td class="tbright"><div style="display:inline;float:left;">
<input name="txt_sname" type="text" id="txt_sname" style="width: 200px; " required  value='<%= rs.getString("sname") %>' /></div>
</div> 
 </td></tr>
...
<td class="tbright"><div style="display:inline;float:left;">
<input name="txt_guig" type="text" id="txt_guig" style="width: 200px; "   value='<%= rs.getString("guig") %>' /></div>
</div> 
 </td></tr>
    ...
    <tr>
        ...
        <input type="submit" name="btnAdd" value="编 辑"  id="btnAdd"  class="layui-layer-btn0 btn btn-primary" />
